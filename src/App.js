...
// Calculate total worked including optional split shift
function calcTotalWorked(form) {
  ...
  if (shift1 == null && shift2 == null) return null;
...
const defaultEntry = () => ({ start: "", end: "", breaks: [], note: "", splitShift: false, start2: "", end2: "" });
      ...
      {editingDay && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "flex-end", zIndex: 100 }}
          ...
          <div onClick={e => e.stopPropagation()} style={{ background: "#F7F5F2", width: "100%", borderRadius: "20px 20px 0 0", padding: "24px 20px 48px", maxHeight: "90vh", overflowY: "auto" }}>
            ...
            {/* Split Shift Toggle */}
            <button
              onClick={() => setForm(f => ({ ...f, splitShift: !f.splitShift, start2: "", end2: "" }))}
              style={{
                display: "flex", alignItems: "center", gap: 8,
